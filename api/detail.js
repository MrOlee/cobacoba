module.exports = async (req, res) => {
  ...
  if (!detailPath) {
    return res.status(200).json({ success: false, error: "detailPath tidak boleh kosong" });
  }
  ...
  return res.status(200).json({ success: false, message: "Gagal memuat detail anime." });
};
